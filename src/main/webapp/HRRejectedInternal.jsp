...
<%-- <td><button formaction="hrApproveInternal${j.employeeId}" id="demo" type = "submit" >Approve</button></td>
<td> <button formaction="hrRejectInternal${j.employeeId}" id="demo" type = "submit" >Reject </button></td> --%>
</tr>
</c:forEach>
</table>
</form:form>
