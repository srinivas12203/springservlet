...
<td><button formaction=trApproveInternal${j.employeeId} class="btn btn-blue-grey" id="demo" type = "submit" >Approve</button></td>
<td><button formaction=trRejectInternal${j.employeeId}  class="btn btn-blue-grey" id="demo" type = "submit" >Reject </button></td>
<td><button formaction=trInternalFeedback class="btn btn-blue-grey" id="demo" type = "submit" >Feedback </button></td>
</tr>
</c:forEach>
</table>
</form:form>
