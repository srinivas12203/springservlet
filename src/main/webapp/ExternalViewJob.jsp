...
%>  --%>
 <div id="abc" class="container">
  ...
  <p class="text-center"><em><span style:color="blue"></span>Jobs That are Recommonded for U</em></p>
...
 
<td><c:out value="${j.jobDescription}"></c:out></td>

 <td> <button class="button" formaction="confirm1${j.jobId}">Apply</button> </td> 
