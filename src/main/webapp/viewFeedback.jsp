...
<c:if test="${empty viewlist}">
    <p class="text-center"><em><span style:color="blue"></span>No Feedback available</em></p>
</c:if>
<c:if test="${not empty viewlist}">
    
<p class="text-center"><em><span style:color="blue"></span>Feedback of Recruiting Process</em></p>
<form:form>


<c:forEach items="${viewlist}" var="j">
<table class="table table-hover">
<th>Name</th><td><c:out value="${j.name}"></c:out></td><tr>
<th>Email Id</th><td><c:out value="${j.emailId}"></c:out></td><tr>
<th>Experience</th><td><c:out value="${j.rating}"></c:out></td><tr>
<th>Comments</th><td><c:out value="${j.comment}"></c:out></td>
<tr class="break">
</table>
</c:forEach>
...
<footer class="text-center">
  ...
  <p><a href="#" data-toggle="tooltip" >www.vconnect.com</a></p> 
</footer>
<%
response.setHeader("Cache-Control","no-cache,no-store,must-revalidate");
response.setHeader("pragma","no-cache");
