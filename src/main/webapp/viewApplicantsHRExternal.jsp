      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="viewhrprofile">Profile</a></li>
...
<td><button formaction="hrApproveExternal${j.candidateId}"  class="btn btn-blue-grey" id="demo" type = "submit" >Approve</button></td>
<td> <button formaction="hrRejectExternal${j.candidateId}" id="demo" class="btn btn-blue-grey"  type = "submit" >Reject </button></td>
</tr>
</c:forEach>
</table>
