...
<td><button formaction="trApproveExternal${j.candidateId}" class="btn btn-blue-grey" id="demo" type = "submit" >Approve</button></td>
<td> <button formaction="trRejectExternal${j.candidateId}"  class="btn btn-blue-grey" id="demo" type = "submit" >Reject </button></td>
</tr>
</c:forEach>
</table>
