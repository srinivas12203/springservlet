  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#tour">GET ENGAGED</a></li>
        <li><a href="#contact">CONTACT</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">CANDIDATE
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="logine">Employee</a></li>
            <li><a href="viewjob">External</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="C:\Users\prasannakn\Desktop\pic1.jpg" alt="New York" width="1200" height="700">
        <div class="carousel-caption">
          <center>
<form:form class="form-inline" action="" >
<div class="form-group">
<form:input  path="jobDomain" class="form-control"  size="50" id="email"/></div>
<form:button type="submit" class="btn btn-default">Search</form:button>
      ...
      <div class="item">
        <img src="C:\Users\prasannakn\Desktop\n16.png" alt="Chicago" width="1200" height="700">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="C:\Users\prasannakn\Desktop\pic2.jpg" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>VConnect</h3>
          <p>Helping you turn what's possible into what's feasible </p>
        </div>      
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <a href="#demo" data-toggle="collapse">
        <img src="C:\Users\prasannakn\Desktop\set.jpg"  class="img-circle person" alt="Random Name" width="255" height="255">
      </a>
...
to not weed out qualified candidates.</p>
    ...
    <div class="col-sm-4">
      ...
      <a href="#demo2" data-toggle="collapse">
        <img src="C:\Users\prasannakn\Desktop\res1.jpg"  class="img-circle person" alt="Random Name" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      ...
      <a href="#demo3" data-toggle="collapse">
        <img src="C:\Users\prasannakn\Desktop\client1.jpg"  class="img-circle person" alt="Random Name" width="255" height="255">
      </a>
   ...
   <p class="row" class="lead">"Vconnect Recruit has been an invaluable resource for our business. 
    ...
    <div class="row text-center">
      ...
      <a href="#demo4" data-toggle="collapse">
        <img src="C:\Users\prasannakn\Desktop\13.png"  class="img-circle person" alt="Random Name" width="255" height="255">
      </a>
    ...
    using Vconnect Recruit's very own Resume Extractor</p>
      ...
      <a href="#demo5" data-toggle="collapse">
        <img src="C:\Users\prasannakn\Desktop\12.jpg"  class="img-circle person" alt="Random Name" width="255" height="255">
      </a>
    ...
    using Vconnect Recruit's very own Resume Extractor</p>
     ...
     <!--  <div class="col-sm-4">
      ...
      <a href="#demo6" data-toggle="collapse">
        <img src="C:\Users\prasannakn\Desktop\14.jpg"  class="img-circle person" alt="Random Name" width="255" height="255">
      </a>
...
<img src="C:\Users\prasannakn\Desktop\map2.jpg" class="img-responsive" style="width:100%">
