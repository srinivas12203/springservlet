...
<form:form action="loginvalidate" method="POST">
<tr>
							<td><form:label path = "employeeId" >EmployeeId</form:label></td>
							<td><form:input path = "employeeId" /></td>
						</tr>
						<tr>
							<td><form:label path = "basicDetails.password" >password</form:label></td>
							<td><form:password path= "basicDetails.password" /></td>
						</tr>
...
<tr><td><a href="#">Forget password??</a></td>
</tr>
</form:form>
</table>
</div>
