...
<%-- <td><button formaction="adminApprove${j.candidateId}" id="demo" type = "submit" >Approve</button></td>
<td> <button formaction="adminReject${j.candidateId}" id="demo" type = "submit" >Reject </button></td>  --%>
</tr>
</c:forEach>
</table>
...
<div id="footer">CopyRight@Vconnect</div>
</body>
</html>